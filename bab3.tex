...
\todo{ \tab~\ref{tab:tipe_anotasi} berikut berisi anotasi tipe dependensi dan deskripsi singkat berdasarkan Universal Dependencies 2.0 \citep{nivre2017universal} yang diadopsi dari panduan dependensi milik Stanford Parser \citep{de2008stanford}.}
...
\todo{tambahin penjelasan mengenai hubungan klausa yang krusial saja dengan contoh 1 kalimat yang bisa dikembangkan}
...
%-----------------------------------------------------------------------------%
\subsection{Percobaan Acak untuk Menguji Hipotesis Efisiensi Kalimat}
%-----------------------------------------------------------------------------%
...
%-----------------------------------------------------------------------------%
\subsection{Analisis Pengaruh Persebaran Panjang Kalimat Terhadap Efisiensi Kalimat}
%-----------------------------------------------------------------------------%
